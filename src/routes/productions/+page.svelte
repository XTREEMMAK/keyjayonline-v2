...
<div class="min-h-screen bg-gradient-to-br from-gray-900 via-orange-900/10 to-gray-900">
		...
		<div class="relative z-10 p-8 pb-16">
			{#if titleVisible}
				<div class="hero-text-container">
					<h1 class="productions-title text-6xl sm:text-7xl md:text-8xl font-bold text-white" class:animate={titleAnimated}>
						PRODUCTIONS
					</h1>
	...
	<div style="margin-top: -80px; position: relative; z-index: 20;">
		<SvgDivider type="curve" flipY={true} className="text-orange-900" />
	</div>

	<!-- Process Section -->
	<section class="bg-gradient-to-br from-orange-900/20 via-gray-900 to-red-900/20 py-20" style="margin-top: -80px; padding-top: 120px;">
		<div class="container mx-auto px-4">
			<div class="text-center mb-12">
