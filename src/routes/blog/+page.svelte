...
<div class="min-h-screen bg-gradient-to-br from-gray-900 via-rose-900/10 to-gray-900">
		...
		<div class="relative z-10 p-8 pb-16">
			{#if titleVisible}
				<div class="hero-text-container">
					<h1 class="blog-title hero-title-responsive font-bold text-white" class:animate={titleAnimated}>
						BLOG
					</h1>
	...
	<section class="bg-gray-900/95 backdrop-blur-sm py-12 border-b border-gray-800 z-10" style="margin-top: -60px; padding-top: 80px;">
	...
	<!-- Blog Posts Grid -->
	<section class="bg-gray-900/50 py-20 z-10">
		<div class="container mx-auto px-4">
	...
	<!-- Newsletter Signup -->
	<section class="bg-gray-800 py-20 section-curve-top z-0" style="margin-top: -80px; padding-top: 100px;">
